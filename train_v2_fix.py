...
if __name__ == '__main__':
    ...
    parser.add_argument('--bsalign-tmp', type=str, default='./tmp', )
    ...
    train_dataset = MAS_Realtime_Dataset_Bsalign_v2(
        data_path=args.data, total_cnt=args.data_limit, max_depth=args.max_depth, min_depth=args.min_depth, tmp_dir=args.bsalign_tmp, context_len=args.context_len, is_validate=False, train_ratio=0.98, train_record_ratio=0.75, seed=42,
    )
    valid_dataset = MAS_Realtime_Dataset_Bsalign_v2(
        data_path=args.data, total_cnt=args.data_limit, max_depth=args.max_depth, min_depth=args.min_depth, tmp_dir=args.bsalign_tmp, context_len=args.context_len, is_validate=True, train_ratio=0.98, train_record_ratio=0.75, seed=42,
    )
